...
def test_markdownprinter():
    ...
    assert md.read() == (
        ...
        "```md\n"
        "\n"
        "[`full sweep results`](tests/test_old/Outputs/test_util/test_markdownprinter/doc.md)\n"
        "\n"
        "![](a/b/c.png)\n"
        "\n"
        "![](d/e.png)\n"
        ...
        "```md\n"
        "\n"
        "[`full sweep results 2`](tests/test_old/Outputs/test_util/test_markdownprinter/doc.md)\n"
        "\n"
        "```\n"
    )
